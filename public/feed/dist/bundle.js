(function (global, factory) {
    ...
    class SymbolsStorage {
        ...
        searchSymbols(searchString, exchange, symbolType, maxSearchResults) {
            console.log("searchSymbols", searchString);
            return this._readyPromise.then(() => {
        ...
        _requestExchangeData(exchange) {
            ...
            //const bids = query.bids({limit: 10});
            //const groups = _.groupBy(bids, 'group');	
            //console.error("bids",bids)
    ...
    class GraphQLDatafeed extends GraphQLDatafeedBase {
    ...
    exports.GraphQLDatafeed = GraphQLDatafeed;
